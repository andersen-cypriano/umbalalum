...
<section class="js-category-controls category-controls container visible-when-content-ready">
	<div class="row justify-content-end mb-md-12">
		<div class="{% if products %}col-12{% else %}col-12{% endif %} d-none d-md-block">
			<div class="row">
				<div class="col-auto col-12 align-self-center">
					{% include "snipplets/breadcrumbs.tpl" %}
				</div>
				<div class="visible-when-content-ready col-12 text-center">
					{% include "snipplets/grid/filters.tpl" with {applied_filters: true} %}
				</div>
			</div>
		</div>
		<div class="filtro-mobile visible-when-content-ready col-6 col-md-3 d-md-none">
