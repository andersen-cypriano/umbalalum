...
header {
  > div.container {
    ...
    > div {
      border-bottom: 1px solid rgba($color: #707070, $alpha: .1)!important;
      > div {
        &:nth-of-type(3) {
          form {
            > .form-group {
...
.js-product-quickshop-variants {
  .content-variant-tamanho {
    label[for="variation_1"], select[id="variation_1"], 
    .form-select-icon, .select-selected {
      display: none!important;
      width: 0!important;
      height: 0!important;
      visibility: hidden!important;
...
// HOME ESTAMPAS
section.section-estampas-home-lista {
  .container {
    h3 {
      text-align: center;
    }
    ul.menu-lista-estampas {
      list-style: none;
      padding: 0;
      margin: 0 0 2rem 0;
      display: flex;
...
#filters {
  ...
  span.checkbox {
    > .checkbox-icon {
      border: 1px solid rgba($color: #707070, $alpha: .3);
    }
  }
  .abre-fecha {
    cursor: pointer;
...
@media (max-width: 768px) {
  ...
  // Body
  section.js-category-controls.category-controls.container.visible-when-content-ready {
    top: 80px!important;
  }
  .js-category-controls {
    z-index: 1000;
