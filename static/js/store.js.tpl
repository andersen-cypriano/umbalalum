...
$(document).ready(function(){
        ...
        {# Show and hide mobile nav on scroll #}
            ...
            function hasScrolled() {
                ...
                if (st > lastScrollTop && st > 10){
                    $(".js-head-main").addClass('compress');
                    if ($(window).width() < 768) {
	...
	{% if template == 'home' %}
        ...
        {% if has_featured_products_slider or has_new_products_slider or has_sale_products_slider %}
            ...
            var slidesPerViewDesktopVal = {% if columns == 2 %}4{% else %}4{% endif %};
    ...
    {% if template == 'product' %}
        ...
        {% set columns = settings.grid_columns %}
         createSwiper('.js-swiper-related', {
            ...
            breakpoints: {
                640: {
                    slidesPerView: {% if columns == 2 %}1{% else %}4{% endif %},
                }
            }
        });
	...
	{% if template == 'product' %}
        ...
        $('.tit-prod-description').click(function(e){
            e.preventDefault();
    ...
    {% if template == '404' and show_help %}
        ...
        createSwiper('.js-swiper-related', {
            ...
            breakpoints: {
                640: {
                    slidesPerView: {% if columns == 2 %}4{% else %}4{% endif %},
                }
            }
        });
