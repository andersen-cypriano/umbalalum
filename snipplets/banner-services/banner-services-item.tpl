        ...
        <div class="row align-items-center">
            <div class="col-auto">
                {% if banner_services_icon == 'shipping' %}
                    {% include "snipplets/svg/caminhao-mt.tpl" with {svg_custom_class: "icon-inline icon-5x svg-icon-text"} %}
                ...
                {% elseif banner_services_icon == 'security' %}
                    {% include "snipplets/svg/cadeado-mt.tpl" with {svg_custom_class: "icon-inline icon-5x svg-icon-text"} %}
                ...
                {% elseif banner_services_icon == 'whatsapp' %}
                    {% include "snipplets/svg/telefone-mt.tpl" with {svg_custom_class: "icon-inline icon-5x svg-icon-text"} %}
