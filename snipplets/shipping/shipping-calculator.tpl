...
<div class="row">
{% endif %}
<div class="mb-2 col-12 calcular-cep-cart" data-store="shipping-calculator">
			...
			{% endblock input_append_content %}
				...
				{% if store.country == 'BR' or 'AR' or 'MX' %}
					...
					<div class="col-12">
						...
						<a class="font-small text-primary mt-2 mb-2 float-right pl-2 d-block {% if product_detail %} js-shipping-zipcode-help {% endif %}" href="{% if store.country == 'AR' %}{{ zipcode_help_ar }}{% elseif store.country == 'BR' %}{{ zipcode_help_br }}{% elseif store.country == 'MX' %}{{ zipcode_help_mx }}{% endif %}" target="_blank">{{ "No sé mi código postal" | translate }}</a>
					</div>
				{% endif %}
				<div class="col-12">
