<a href="#" class="js-product-thumb {% if loop.last and last_open_modal %}js-product-thumb-modal{% endif %} product-thumb d-block position-relative mb-3 {% if loop.first %}selected{% endif %}{% if settings.theme_rounded %} {% endif %}" style="padding-bottom: {{ image.dimensions['height'] / image.dimensions['width'] * 100}}%;" data-thumb-loop="{{loop.index0}}">
