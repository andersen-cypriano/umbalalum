                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_01_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_01.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_02_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_02.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_03_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_03.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_04_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_04.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_05_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_05.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_06_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_06.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_07_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_07.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_08_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_08.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_09_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_09.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                        ...
                        <div class="swiper-slide">
                            <a href="{{ settings.icone_cat_10_url | setting_url }}">
                                ...
                                <img src="{{ 'images/empty-placeholder.png' | static_url }}" data-srcset='{{ "icone_cat_10.jpg" | static_url }}' class="lazyload fade-in" />
                            </a>
                        </div>
                        {% endif %}
                    </div>
