            ...
            <div class="js-item-variants">
                ...
                <div class="item-price-container mb-1" data-store="product-item-price-{{ product.id }}">
                    <span class="js-compare-price-display price-compare" {% if not product.compare_at_price or not product.display_price
                        %}style="display:none;" {% else %}style="display:inline-block;" {% endif %}>
            ...
            <div class="item-actions mt-2">
                ...
                {% else %}
                    ...
                    <form id="product_form" class="js-product-form" method="post" action="{{ store.cart_url }}">
                        ...
                        <input type="number" name="quantity" value="1" class="js-quantity-input hidden eita" aria-label="{{ 'Cambiar cantidad' | translate }}" >
