		...
		<div class="row">
			<div class="col-md-12 text-center mb-3 mb-md-0">
				<div class="col-md-12 text-center d-flex justify-content-center">
	                ...
	                #}
	                {{ new_powered_by_link }}
					<div class="design-by-logo">
						<a href="https://www.mtsolucoes.com.br/?utm_source=Estilo_MID_medium=MID" target="_blank" title="MT Soluções">
							{% include "snipplets/svg/logo-MT-Solucoes.tpl" %}
						</a>
					</div>
